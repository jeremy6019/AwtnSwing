...
public class LoginFrame extends JFrame {
		...
		public LoginFrame() {
			...
			//TitledBorder를 이용하면 경계선과 텍스트를 같이 출력 
		    ...
		    //btnLogin버튼을 누르면 아이디와 비밀번호를 가져와서
		    //아이디가 root이고 비밀번호가 1234이면 로그인 성공이라고
            //그렇지 않으면 로그인 패라고 lblTitle에 출력 
